...
acusacoes = {2:"Suspeita",3 or 4: "Cúmplice",5:"Assassino"}
cont = 0
perguntas_sim = []
print("\033[34m vc podererar responder {sim ou s} para[sim] e {não ou n} para[não]\033[34m")
